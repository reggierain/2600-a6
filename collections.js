            ...
            $jsonSchema: {
                ...
                properties: {
                    title: {
                        ...
                        minLength: 2,
                        maxLength: 30,
                        description: "The title length should be between 2 and 30 characters."
                    },
                    numberOfSeasons: {
                        bsonType: "int",
                        minimum: 1,
                        description: "The number of seasons should have a minimum value of 1."
                    },
                    firstEpisodeYear: {
                        bsonType: "int",
                        minimum: 1900,
                        maximum: 2100,
                        description: "The first episode year should be in between 1900 and 2100."
                    },
                    topActors: {
                        bsonType: "array",
                        minItems: 1,
                        items: {
                            ...
                            properties: {
                                actor_id: {
                                    bsonType: "objectId",
                                    description: "The actor_id must be a valid objectId from actors collection."
                                }
                            }
                        }
                    }
